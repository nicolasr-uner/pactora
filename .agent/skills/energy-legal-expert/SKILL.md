...
- Hitos Críticos: Fórmulas de indexación (IPP/IPC), Fechas de Operación Comercial (COD), Notice to Proceed (NTP), garantías y pólizas.
- Lógica Intercompany: Diferencias el riesgo si el contrato es intergrupo (Suno - Unergy - Solenium) vs Terceros externos.
